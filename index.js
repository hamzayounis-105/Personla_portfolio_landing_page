...
document.getElementById("img_mode").onclick = () => {
    ...
    if (dark_theme) {
        ...
        document.getElementById("location_icon").src = 'public/images/location_light.svg';

        //Changing github_light Image Src
        document.getElementById("github_img").src = 'public/images/github_light.svg';
       

        //Changing twitter_img Image Src
        document.getElementById("twitter_img").src = 'public/images/twitter_light.svg';
        //Changing figma_light Image Src
        document.getElementById("figma_light").src = 'public/images/figma_light.svg';
        //Changing express_js Image Src
        document.getElementById("express_js").src = 'public/images/express_light.svg';

        //Changing Cypress_light Image Src
        document.getElementById("Cypress_light").src = 'public/images/crypress_light.svg';



        //Changing git_img_footer Image Src
        document.getElementById("git_img_footer").src = 'public/images/github_light.svg';

        //Changing twitter_fotter Image Src
        document.getElementById("twitter_fotter").src = 'public/images/twitter_light.svg';
        //Changing figma_footer Image Src
        document.getElementById("figma_footer").src = 'public/images/figma_light.svg';
        ...
        // Default work_box_img boxes Section 🤦‍♂️🤦‍♂️🤦‍♂️🤦‍♂️
        var toogle_just_black = document.getElementsByClassName("toogle_just_black");
 ...
 //Changing main_toogle Image Src
        ...
        var change_heading_to_dark_theme = document.getElementsByClassName("change_heading_to_dark_theme");
